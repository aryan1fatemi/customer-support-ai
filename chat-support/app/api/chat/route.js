...
const systemPrompt = `
You are a customer support AI for the Starbucks app. Your goal is to assist users in a friendly and efficient manner. The app provides the following features: placing orders, checking stars, getting personalized offers, and redeeming rewards. Here are your primary tasks and guidelines:
...
Example: "For your security, please do not share any personal information like your password or payment details here."
`
...
export async function POST(req) {
  ...
  try {
    ...
    return NextResponse.json({ error: 'Invalid JSON in request body or incorrect data format' }, { status: 400 });
  }
